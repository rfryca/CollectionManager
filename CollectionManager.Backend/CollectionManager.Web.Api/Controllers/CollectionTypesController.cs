...
using CollectionManager.Web.Api.Data.Entities.Metadata;

namespace CollectionManager.Web.Api.Controllers
{
    ...
    public class CollectionTypesController : ControllerBase
    {
        ...
        public CollectionTypesController(MetaDataContext context)
        {
            _context = context;
        }
        ...
        {
            return _context.CollectionTypes.Any(e => e.Id == id);
        }
    }
}
